...
export class default1678199293982 implements MigrationInterface {
    name = 'default1678199293982'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "recipe" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "category" character varying NOT NULL, "preparation_time" integer NOT NULL, "servings" integer NOT NULL, "created_At" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "author" character varying NOT NULL, CONSTRAINT "PK_e365a2fedf57238d970e07825ca" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "instruction" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "description" character varying NOT NULL, "order" character varying NOT NULL, "tip" character varying NOT NULL, "recipeIdId" uuid, CONSTRAINT "REL_d549362f7edccb89a5182a14ee" UNIQUE ("recipeIdId"), CONSTRAINT "PK_dd8def68dee37e3f878d0f8673a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "review" ("id" SERIAL NOT NULL, "rating" integer NOT NULL, "comment" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "recipeIdId" uuid, CONSTRAINT "PK_2e4299a343a81574217255c00ca" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "ingredientes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "quantity" character varying NOT NULL, "measure" character varying NOT NULL, "recipeIdId" uuid, CONSTRAINT "REL_b3b1eb34a48f116290baabbdde" UNIQUE ("recipeIdId"), CONSTRAINT "PK_8901a565cc70a661928d2011f2f" PRIMARY KEY ("id"))`);
